...
public class Util
{
	...
	/**
	 * Recebe como parâmetro um horário no formato HH:mm e verifica se o mesmo é válido.
	 * @param horaMinuto
	 * @return boolean
	 */
	...
	/**
	 * Recebe como par�metro quantidade em mintuos e transforma em hor�rio no formato HH:mm
	 * @param minutos
	 * @return
	 */
    ...
    public static boolean isCpf(String cpf)
    {
    	...
    	else cpf = limparStringCaracteresLetras(cpf);
    ...
    public static boolean isCpfValido(String cpf)
    {
    	...
    	if(cpf.replace(cpf.substring(0,1), "").length() == 0) return false;
    ...
    public static boolean isCnpjValido(String cnpj)
    {
    	...
    	else cnpj = limparStringCaracteresLetras(cnpj);
    	if(cnpj.length() != 14) return false;
    	if(cnpj.replace(cnpj.substring(0,1), "").length() == 0) return false;
